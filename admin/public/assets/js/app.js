+function($, window){ 'use strict';
	...
	// initialize menubar
	app.$menubar.removeClass('light').addClass('dark').addClass('in');
	...
	var menubar = {
		...
		reduceAppMenu: function(){
			...
			if ($menuItems.length > 5) {
				...
				$moreItemsToggle.append(['<i class="menu-icon zmdi zmdi-more-vert zmdi-hc-lg"></i>', '<span class="menu-text">Diğer Menüler...</span>', '<i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>']);
