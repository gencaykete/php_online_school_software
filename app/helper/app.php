...
define('CRYPTO_KEYWORDS', 'f32f299ac12a74f2db2b74530f4b35lg');
function arc_decode($decrypt) {
        $decoded = base64_decode($decrypt);
        $iv = mcrypt_create_iv(mcrypt_get_iv_size(MCRYPT_RIJNDAEL_256, MCRYPT_MODE_ECB), MCRYPT_RAND);
        $decrypted = trim(mcrypt_decrypt(MCRYPT_RIJNDAEL_256, CRYPTO_KEYWORDS, trim($decoded), MCRYPT_MODE_ECB, $iv));
        return $decrypted;
}
