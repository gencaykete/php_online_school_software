			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Sağlık Bilgisi Güncelle</h4>
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" name="ill_student">
                    ...
                    <?php foreach ($student as $row): ?>
                      <option value="<?=$row['user_id']?>"<?=$row['user_id']==$query['ill_student'] ? ' selected' : NULL ?>><?=$row['user_name']?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
							</div>
              <div class="form-group">
								...
								<div class="col-sm-5">
                  <input type="text" name="ill_complaint" class="form-control" placeholder="Şikayet" value="<?=$query['ill_complaint']?>">
                </div>
							</div>
              <div class="form-group">
								<label for="#" class="col-sm-2 col-sm-offset-2 control-label">İlgilenen Yetkili</label>
								<div class="col-sm-5">
                  <input type="text" name="ill_doctor" class="form-control" placeholder="İlgilenen Yetkili" value="<?=$query['ill_doctor']?>">
                </div>
							</div>
              <div class="form-group">
								<label for="#" class="col-sm-2 col-sm-offset-2 control-label">Tanı</label>
								<div class="col-sm-5">
                  <textarea name="ill_detail" class="form-control" placeholder="Tanı" rows="8" cols="80"><?=$query['ill_detail']?></textarea>
                </div>
							</div>
