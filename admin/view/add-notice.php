			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Duyuru Ekle</h4>
              ...
              <div class="form-group">
								...
								<div class="col-sm-5">
									<input class="form-control" type="text" name="notice_title" placeholder="Duyuru Başlığı">
								</div>
							</div>
              <div class="form-group">
                    ...
                    <option value="1">Herkese</option>
                    <option value="3">Öğretmenlere</option>
                    <option value="4">Öğrencilere</option>
                    <option value="5">Velilere</option>
                  </select>
								</div>
							</div>
              <div class="form-group">
								...
								<div class="col-sm-5">
									<textarea name="notice_detail" class="form-control" rows="8" cols="80" placeholder="Duyuru Detayı"></textarea>
								</div>
							</div>
